...
<nav class="nav">
  ...
  <a href="/admin/captura">Captura</a>
  <a href="/admin/credito">Crédito</a>
  ...
  <a href="/admin/remitentes">Remitentes</a>
  <a href="/admin/sellado">Sellado</a>
  <a href="/admin/usuarios">Usuarios</a>
  <form method="post" action="/admin/salir" style="margin-left:auto">
    <button type="submit" style="background:none;border:1px solid #3A3F38;color:#C9CEC6;padding:6px 12px;border-radius:6px;cursor:pointer;font-weight:600;font-size:13px">Salir</button>
  </form>
</nav>
<main>
${cuerpo}
